<template>
  <div class="banner-1">
    ...
    <div class="flex items-center">
      <div class="w-11/12 space-y-5 md:space-y-10">
        <h1
          class="3xl:text-7xl 2xl:text-7xl xl:text-6xl lg:text-4xl md:text-3xl sm:text-3xl text-xl font-Moscow2024 font-bold leading-tight text-gray-700"
        >
        Аниме ночники:
          <a>
          магия света и тени</a
          ><br />для твоей комнаты
        </h1>
  ...
  <div class="banner-2 space-y-10 pb-20" id="work">
    <h3 class="heading3 my-5">Текст</h3>
    <div class="card">
  ...
  <div class="banner-1 flex h-full items-center">
    ...
    <div class="w-5/12 pr-28">
      <div class="flex flex-wrap justify-end gap-2">
        ...
        <div class="copyright">
        Copyrights © 2024 Eori. All Rights Reserved. 
        </div>
       </div>
    </div>
  </div>
